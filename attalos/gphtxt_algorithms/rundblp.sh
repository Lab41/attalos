...
awk '{print tolower($0)}' temp.txt > temp2.txt

# Remove all the periods with gsub.
echo "Removing some punctuation"
...
python remove1char.py temp3.txt > authortitles.txt
